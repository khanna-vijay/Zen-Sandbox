...
| Change | Type |
|---|---|
| **Domain 3 now holds both engines** (Game + Narrative) with an *Engine Selection* meta-skill | **Paradigm fix** |
| Added Principle **Serve the Story**; Skill **Narrative Architecture**; Techniques Story Spine, Platform/Tilt, Protag/Antag | New content |
| Separated **Heightening the Game** (pattern) from **Raising the Stakes** (consequences) | MECE fix |
| Added Skill **Stakes / The "Want"** — scoped against CROW's "O" and Raising the Stakes | New + scoped |
| Added Principle **Vulnerability** (truth) — distinct from Fail Joyfully (risk) | New content |
| Added Skill **Silence & Stillness** | New content |
| Added Principle **Consent & Boundaries** — *taught first*, overrides agreement | **Safety-critical** |
| Added Skill **Active Gifting** (inverse of Offer Reception) | New content |
| Added Skill **Support Work** — scoped as *output* vs. Peripheral Awareness *input* | New + MECE fix |
| Added Skill **Suggestion Deconstruction (A-to-C)** | New content |
| Added Technique **Breaking the 4th Wall / Direct Address** | New content |
| Redefined layers as **muscle / brain / value** | Definition sharpening |
| Rewrote **all Novice cells** as attempt-under-load | Rubric methodology |
| Rewrote **all Master cells** as observable behavior (removed "telepathic," "heartbeat") | Rubric methodology |
| D5 Room Reading master upgraded to **"unify the room"** (observable) | Refinement |
