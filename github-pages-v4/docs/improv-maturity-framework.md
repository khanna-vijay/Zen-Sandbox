...
|---|---|---|
| **Domain** | *In relation to whom/what?* | Self → Partner → Scene → Ensemble → Audience |
...
| **2. Adv. Beginner** | Sustains it reliably in **drills / low-pressure** settings | Technique (fluent) |
| **3. Competent** | **Selects the right tool** under live scene pressure | Technique → Skill bridge |
