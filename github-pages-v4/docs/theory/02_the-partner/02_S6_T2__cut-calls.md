...
![Square infographic explaining the improv technique “Cut calls”](../../assets/infographics/D2.S6.T2.jpg){ .infographic }
...
*   **Chelsea Pace, *Staging Sex: Best Practices, Tools, and Techniques for Theatrical Intimacy* (2020)** — A definitive manual that provides practical tools for boundary establishment and de-loading processes. It provides the vocabulary for actors to advocate for their physical and emotional well-being over the narrative, directly applicable to the philosophy behind improv safety tools. [Routledge]{.ref}
