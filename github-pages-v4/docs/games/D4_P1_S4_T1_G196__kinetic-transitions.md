...
- **Technique(s):** Edits (Sweep, Tag-Out, Sound/Light); Timing exercises; Stage-picture exercises; A-to-C drills; Callbacks & Mapping
- **Focus:** connection
...
## Facilitation Notes
- Coaching Cue: 'Breathe the ending in.' Remind offstage players that the collective breath is not a passive pause, but an active absorption of the scene's final heartbeat.
- Pitfall: Players rush the transition, stepping into the next scene before the ensemble has fully embodied the resonance. Fix: Have the facilitator physically hold space or count down three silent seconds before allowing anyone to step forward.
- Coaching Cue: 'Match the physical tension.' Encourage incoming players to start with their bodies first, letting the physical shape dictate their first line of dialogue.
- Pitfall: The incoming scene completely ignores the previous scene's energy, resetting to a neutral, conversational tone. Fix: Pause the scene and ask the players to restart, explicitly dialing up the physical or emotional volume to match the resonance phase.
...
- What physical cues did you find easiest to inherit and translate into a completely new context?
