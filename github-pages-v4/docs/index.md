...
🎵 [Amateur Improv Community Anthem](https://www.youtube.com/watch?v=9Qi_dvZmFyI)
...
<div style="max-width:720px; margin:1.2rem 0;">
  <iframe style="width:100%; aspect-ratio:16/9; border:0; border-radius:.4rem;"
    ...
    title="The Amateur Improv Community Anthem"
...
<img src="assets/infographics/improv-rings.png"
     alt="The Rings of Improv — a colorful guide to liberation and creativity. Ring 1, the Inner Core (mindset): silence the inner critic, be in the present, develop intuition. Ring 2, the Interpersonal Layer (action): radical listening with 'Yes, And', prioritise fun and play, embrace uncertainty, adapt status. Ring 3, the Outer Manifestation (results): fearless risk-taking, everyday creativity, elite collaboration, resilient adaptability."
     class="infographic" style="max-width: 820px;" loading="lazy">
